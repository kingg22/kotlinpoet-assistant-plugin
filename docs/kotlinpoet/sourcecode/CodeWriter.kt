...
internal class CodeWriter(
     ...
     */
    private fun shouldEmitPublicModifier(modifiers: Set<KModifier>, implicitModifiers: Set<KModifier>): Boolean {
     ...
     */
    private fun suggestedTypeImports(): Map<String, Set<ClassName>> = importableTypes.filterKeys {
        it !in referencedNames
     ...
     * collisions, import aliases will be generated.
     */
    private fun suggestedMemberImports(): Map<String, Set<MemberName>> = importableMembers.mapValues {
        it.value.toSet()
    }
